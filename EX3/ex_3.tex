...
\SetKwRepeat{Repita}{Faça}{Enquanto}
...
\begin{algorithm}[H] \label{alg:cmeans}
	...
	\Repeat{$\lVert C^{(t)}-C^{(t-1)} \rVert < \epsilon$}{
		Incrementar $k$;\\
		Atualizar $\mu_{ij}$, dado pela Eq. \eqref{eq:membership};\\
		Atualizar cada centro $c_j$, dado pela Eq. \eqref{eq:center};\\
	}
...
\begin{figure}[!htbp]
	\centering
	\subfigure[Imagem $01$]{\includegraphics[width = 0.4\textwidth]{figures/img01.jpg} \label{fig:img_01}}
	\subfigure[Imagem $02$]{\includegraphics[width = 0.5\textwidth, height = 0.26\textheight]{figures/img02.jpg} \label{fig:img_02}}
	\subfigure[Imagem $03$]{\includegraphics[width = 0.3\textwidth]{figures/img03.jpg} \label{fig:img_03}}
...
\begin{figure}[!htbp]
	\centering
	\subfigure[Algoritmo implementado.]{\includegraphics[width = 0.49\textwidth]{figures/data_cmeans.eps}\label{fig:resul_cluster_cmeans}}
	\subfigure[Função \texttt{fcm} do MATLAB.]{\includegraphics[width = 0.49\textwidth]{figures/data_fcm.eps}\label{fig:resul_cluster_fcm}}
...
\begin{figure}[!htbp]
	\centering
	\subfigure[Algoritmo implementado.]{\includegraphics[width = 0.49\textwidth]{figures/img1_4.eps}\label{fig:img1}}
	\subfigure[Função \texttt{fcm} do MATLAB.]{\includegraphics[width = 0.49\textwidth]{figures/matlab_img1_4.eps}\label{fig:img1_matlab}}
...
\begin{figure}[!htbp]
	\centering
	\subfigure[Algoritmo implementado.]{\includegraphics[width = 0.49\textwidth]{figures/img2_3.eps}\label{fig:img2}}
	\subfigure[Função \texttt{fcm} do MATLAB.]{\includegraphics[width = 0.49\textwidth]{figures/matlab_img2_3.eps}\label{fig:img2_matlab}}
...
\begin{figure}[!htbp]
	\centering
	\subfigure[Algoritmo implementado.]{\includegraphics[width = 0.49\textwidth]{figures/img3_6.eps}\label{fig:img3}}
	\subfigure[Função \texttt{fcm} do MATLAB.]{\includegraphics[width = 0.49\textwidth]{figures/matlab_img3_6.eps}\label{fig:img3_matlab}}
